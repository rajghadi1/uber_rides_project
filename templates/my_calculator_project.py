...
btnmul =Button(screen,text='x',font=('arial',20,'italic bold'),bd='8',padx=18,pady=16,command=lambda:click('*'),activebackground='green',activeforeground='white',bg='powder blue')
...
btndiv =Button(screen,text='/',font=('arial',20,'italic bold'),bd='8',padx=19,pady=16,command=lambda:click('/'),activebackground='green',activeforeground='white',bg='powder blue')
btndiv.grid(row=4,column=3)
##########adavance calculation

btnsin =Button(screen,text='sin',font=('arial',15,'italic bold'),bd='8',padx=15,pady=20,command=lambda:click('/'),activebackground='green',activeforeground='white',bg='powder blue')
btnsin.grid(row=0,column=4)

btncos =Button(screen,text='cos',font=('arial',15,'italic bold'),bd='8',padx=15,pady=20,command=lambda:click('/'),activebackground='green',activeforeground='white',bg='powder blue')
btncos.grid(row=1,column=4)

btntan =Button(screen,text='tan',font=('arial',15,'italic bold'),bd='8',padx=15,pady=20,command=lambda:click('/'),activebackground='green',activeforeground='white',bg='powder blue')
btntan.grid(row=2,column=4)

btnsqrt =Button(screen,text='√',font=('arial',15,'italic bold'),bd='8',padx=23,pady=20,command=lambda:click('/'),activebackground='green',activeforeground='white',bg='powder blue')
btnsqrt.grid(row=3,column=4)


btnlog =Button(screen,text='log',font=('arial',15,'italic bold'),bd='8',padx=15,pady=22,command=lambda:click('/'),activebackground='green',activeforeground='white',bg='powder blue')
...
entry1.bind('<Leave>',on_leaveenter)
